...
def bootstrap_system():
    ...
    profile1 = Person(0, "py", "fe", "<1", "win", 0)
    profile2 = Person(1, "py", "be", "1-3", "learn", 10)
    profile3 = Person(2, "py", "fs", "1-3", "network", 2)
    profile4 = Person(3, "py", "fe", "5+", "learn", 4)
    profile5 = Person(4, "ry", "be", "3-5", "win", 5)
    profile6 = Person(5, "ry", "fs", "<1", "learn", 7)
    profile7 = Person(6, "ry", "fe", "1-3", "network", 3)
    profile8 = Person(7, "ry", "fe", "1-3", "learn", 8)
    profile9 = Person(8, "java", "fe", "<1", "win", 8)
    profile10 = Person(9, "java", "be", "1-3", "learn", 2)
    profile11 = Person(10, "java", "fs", "1-3", "network", 5)
    profile12 = Person(11, "java", "fe", "5+", "learn", 7)
    profile13 = Person(12, "js", "be", "3-5", "win", 2)
    profile14 = Person(13, "js", "fs", "<1", "learn", 7)
    profile15 = Person(14, "js", "fe", "1-3", "network", 9)
    profile16 = Person(15, "js", "fe", "1-3", "learn", 10)
    profile17 = Person(16, "c", "fe", "<1", "win", 3)
    profile18 = Person(17, "c", "be", "1-3", "learn", 3)
    profile19 = Person(18, "c", "fs", "1-3", "network", 2)
    profile20 = Person(19, "c", "fe", "5+", "learn", 9)
    profile21 = Person(20, "ch", "be", "3-5", "win", 1)
    profile22 = Person(21, "ch", "fs", "<1", "learn", 10)
    profile23 = Person(22, "ch", "fe", "1-3", "network", 0)
    profile24 = Person(23, "ch", "fe", "1-3", "learn", 3)
    profile25 = Person(24, "cpp", "fe", "<1", "win", 5)
    profile26 = Person(25, "cpp", "be", "1-3", "learn", 6)
    profile27 = Person(26, "cpp", "fs", "1-3", "network", 8)
    profile28 = Person(27, "cpp", "fe", "5+", "learn", 6)
    profile29 = Person(28, "php", "be", "3-5", "win", 3)
    profile30 = Person(29, "php", "fs", "<1", "learn", 4)
    profile31 = Person(30, "php", "fe", "1-3", "network", 7)
    profile32 = Person(31, "php", "fe", "1-3", "learn", 4)
    profile33 = Person(32, "html", "fe", "<1", "win", 2)
    profile34 = Person(33, "html", "be", "1-3", "learn", 10)
    profile35 = Person(34, "html", "fs", "1-3", "network", 0)
    profile36 = Person(35, "html", "fe", "5+", "learn", 2)
    profile37 = Person(36, "css", "be", "3-5", "win", 4)
    profile38 = Person(37, "css", "fs", "<1", "learn", 8)
    profile39 = Person(38, "css", "fe", "1-3", "network", 9)
    profile40 = Person(39, "css", "fe", "1-3", "learn", 3)
    profile41 = Person(40, "perl", "fe", "<1", "win", 5)
    profile42 = Person(41, "perl", "be", "1-3", "learn", 5)
    profile43 = Person(42, "perl", "fs", "1-3", "network", 5)
    profile44 = Person(43, "perl", "fe", "5+", "learn", 3)
    profile45 = Person(44, "swift", "be", "3-5", "win", 7)
    profile46 = Person(45, "swift", "fs", "<1", "learn", 9)
    profile47 = Person(46, "swift", "fe", "1-3", "network", 2)
    profile48 = Person(47, "swift", "fe", "1-3", "learn", 1)
