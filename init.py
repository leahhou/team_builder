...
def bootstrap_system():
    ...
    profile1 = Person(0, "py", "fe", "<1", "win")
    profile2 = Person(1, "py", "be", "1-3", "learn")
    profile3 = Person(2, "py", "fs", "1-3", "network")
    profile4 = Person(3, "py", "fe", "5+", "learn")
    profile5 = Person(4, "ry", "be", "3-5", "win")
    profile6 = Person(5, "ry", "fs", "<1", "learn")
    profile7 = Person(6, "ry", "fe", "1-3", "network")
    profile8 = Person(7, "ry", "fe", "1-3", "learn")
    profile9 = Person(8, "java", "fe", "<1", "win")
    profile10 = Person(9, "java", "be", "1-3", "learn")
    profile11 = Person(10, "java", "fs", "1-3", "network")
    profile12 = Person(11, "java", "fe", "5+", "learn")
    profile13 = Person(12, "js", "be", "3-5", "win")
    profile14 = Person(13, "js", "fs", "<1", "learn")
    profile15 = Person(14, "js", "fe", "1-3", "network")
    profile16 = Person(15, "js", "fe", "1-3", "learn")
    profile17 = Person(16, "c", "fe", "<1", "win")
    profile18 = Person(17, "c", "be", "1-3", "learn")
    profile19 = Person(18, "c", "fs", "1-3", "network")
    profile20 = Person(19, "c", "fe", "5+", "learn")
    profile21 = Person(20, "ch", "be", "3-5", "win")
    profile22 = Person(21, "ch", "fs", "<1", "learn")
    profile23 = Person(22, "ch", "fe", "1-3", "network")
    profile24 = Person(23, "ch", "fe", "1-3", "learn")
    profile25 = Person(24, "cpp", "fe", "<1", "win")
    profile26 = Person(25, "cpp", "be", "1-3", "learn")
    profile27 = Person(26, "cpp", "fs", "1-3", "network")
    profile28 = Person(27, "cpp", "fe", "5+", "learn")
    profile29 = Person(28, "php", "be", "3-5", "win")
    profile30 = Person(29, "php", "fs", "<1", "learn")
    profile31 = Person(30, "php", "fe", "1-3", "network")
    profile32 = Person(31, "php", "fe", "1-3", "learn")
    profile33 = Person(32, "html", "fe", "<1", "win")
    profile34 = Person(33, "html", "be", "1-3", "learn")
    profile35 = Person(34, "html", "fs", "1-3", "network")
    profile36 = Person(35, "html", "fe", "5+", "learn")
    profile37 = Person(36, "css", "be", "3-5", "win")
    profile38 = Person(37, "css", "fs", "<1", "learn")
    profile39 = Person(38, "css", "fe", "1-3", "network")
    profile40 = Person(39, "css", "fe", "1-3", "learn")
    profile41 = Person(40, "perl", "fe", "<1", "win")
    profile42 = Person(41, "perl", "be", "1-3", "learn")
    profile43 = Person(42, "perl", "fs", "1-3", "network")
    profile44 = Person(43, "perl", "fe", "5+", "learn")
    profile45 = Person(44, "swift", "be", "3-5", "win")
    profile46 = Person(45, "swift", "fs", "<1", "learn")
    profile47 = Person(46, "swift", "fe", "1-3", "network")
    profile48 = Person(47, "swift", "fe", "1-3", "learn")
