...
class ProfileForm(Form):
    ...
    experience = RadioField(u'What is your experience level', choices=["Under 1 year", "1-3 years", "3-5 years", "5+ years"], validators=[validators.input_required("Input is required")])
    objective = RadioField(u'What is your objective in this Hackathon?', choices=["Winning a prize","Learning new things", "Networking"], validators=[validators.input_required("Input is required")])
